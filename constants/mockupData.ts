...
export const mockUpCreateGuide = {
  ...
  generalTips:
    "This guide provides essential tips for navigating Ho Chi Minh City, including transportation, local customs, and safety tips.",
  lodging: [
    {
      name: "Rex Hotel",
      address: "141 Nguyen Hue, Ben Nghe, District 1, Ho Chi Minh city",
    ...
    {
      name: "NewWorld Hotel",
      address: "14 Nguyen Hue, Ben Nghe, District 1, Ho Chi Minh city",
      checkIn: "",
      checkOut: "",
      confirmation: "",
      notes:
        "NewWorld Hotel is a historic hotel known for its rooftop bar and central location.",
      cost: {
        type: "VND",
        value: 2000000,
      },
