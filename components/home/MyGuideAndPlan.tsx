...
const MyGuideAndPlan = () => {
  return (
    <div className="flex items-start gap-4">
      <section className="p-4 flex flex-col rounded-lg background-light800_dark300 flex-1 text-dark200-light800  font-extrabold flex justify-between gap-6 text-[1.5em]">
